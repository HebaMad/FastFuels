...
class OrderFilter: UIViewController {
    var popBlocks:(([Int])->Void)?
...
//            SVProgressHUD.show()
           self.sheetViewController?.dismissTapped()
            self.popBlocks?([200, self.OrderStatus ,self.PaymentStatus,self.Ordertype])
...
extension OrderFilter: UITableViewDataSource, UITableViewDelegate {
